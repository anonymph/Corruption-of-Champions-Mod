package classes.Scenes.Places.Farm
{
	...
	public class FarmCorruption extends AbstractFarmContent
	{
		...
		public function whitneyDomRide():void
		{
			...
			if (player.eyeCount == 4)      outputText("  Once she’s finished with that she places another blindfold over your second pair of eyes.  You can only groan with laughter at the sheer level of preparation the dog woman is capable of.");
			else if (player.eyeCount > 4)  outputText("  Realizing you've got too many eyes, she rips off a large piece of the bed linen, and covers your remaining eyes with it.");
			outputText("“<i>Wouldn’t want you to see what’s coming, would we? That’d ruin half the fun.</i>” ");
